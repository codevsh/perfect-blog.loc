...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('Edit Category') }} {{ $category->title }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.category.update', $category->slug) }}" method="POST">
                                @csrf
                                @method('PATCH')
                                @livewire('admin.category-update-component', ['category' =>$category])
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="meta_title" id="meta_title"
                                            ...
                                            value="{{ $category->meta_title }}" wire:model='meta_title'>
                                        @error('meta_title')
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" name="meta_keywords" id="meta_keywords"
                                            ...
                                            value="{{ $category->meta_keywords }}" wire:model='meta_keywords'>
                                        @error('meta_keywords')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('meta_description') border-danger @enderror" name="meta_description"
                                        id="meta_description" rows="3" wire:model='meta_description'>{{ $category->meta_description }}</textarea>
                                ...
                                <button type="submit" class="btn btn-dark">{{ __('Edit Category') }}</button>
                            </form>
                        </div>
