                                                ...
                                                <tbody>
                                                    @foreach ($comments as $comment)
                                                        <tr>
                                                            ...
                                                            <td><a href="{{ route('main.show', $comment->article->slug) }}"
                                                                    class="btn btn-dark btn-sm">{{ __('View') }}</a>
                                                            </td>
                                                            <td><a href="{{ route('profile.comments.edit', $comment) }}"
                                                                    class="btn btn-success btn-sm">{{ __('Edit') }}</a>
                                                            </td>
                                                            <td>
                                                                <form
                                                                    action="{{ route('profile.comments.delete', $comment) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
